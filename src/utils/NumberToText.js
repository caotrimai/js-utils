class NumberToText {
  ...
  currencyToWords = (SoTien) => {
    ...
    if (KetQua===' đồng') return '0 đồng'
    return KetQua;//.substring(0, 1);//.toUpperCase();// + KetQua.substring(1);
  }
}

// const numberToText = new NumberToText()
// const text = numberToText.currencyToWords(123000)
// const text2 = numberToText.currencyToWords(1009628000)
//
// console.log(text)
// console.log(text2)
